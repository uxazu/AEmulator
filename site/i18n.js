// создано docs/readme/gen_site.py — не править вручную
window.AEMU_I18N = {
 "langs": [
  {
   "code": "en",
 ...
 "t": {
  "en": {
   ...
   "st_partial": "Partly",
   "st_wip": "In progress",
   "st_untested": "Not tested yet",
   "st_no": "Not yet",
   "n_sound": "sound works",
   "n_bt": "Bluetooth app dialog",
   "n_nosound": "no sound yet",
   "n_wip": "boots to setup, being stabilised",
   "n_lollipop": "Android 5 is experimental",
   "n_crash": "unofficial port crashes",
   "n_arm64": "64-bit Android 7 — needs the planned arm64 engine",
   "dl_rootfs": "ready-to-import archive",
   "dl_factory": "Google factory image",
   "dl_odin": "Odin package",
   "dl_zip": "recovery ZIP",
   "dl_ftf": "FTF package",
   ...
   "steps": [
    "Download the APK from <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> and install it.",
   ...
   "build_text": "You need JDK 17, Android SDK 36 and NDK r28. Native guest parts are built with the scripts in <code>native/*/build.sh</code>.",
   ...
   "credits_text": "AEmulator grew out of the HTC Desire HD and HTC One M7 emulators by <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">the original author</a> — their engine made this project possible.",
   "support_title": "Support the project",
   "support_text": "If AEmulator brought back a phone you loved, you can support development:",
   "links_title": "Links",
   "l_site": "Website",
   "l_channel": "Telegram channel",
   "l_author": "Author",
  ...
  "ru": {
   ...
   "st_partial": "Частично",
   "st_wip": "В работе",
   "st_untested": "Не проверено",
   "st_no": "Пока нет",
   "n_sound": "звук работает",
   "n_bt": "окно ошибки Bluetooth",
   "n_nosound": "пока без звука",
   "n_wip": "доходит до мастера настройки, дорабатывается",
   "n_lollipop": "Android 5 — экспериментально",
   "n_crash": "неофициальный порт падает",
   "n_arm64": "64-битный Android 7 — нужен будущий движок arm64",
   "dl_rootfs": "готовый архив для импорта",
   "dl_factory": "factory-образ Google",
   "dl_odin": "пакет Odin",
   "dl_zip": "ZIP для рекавери",
   "dl_ftf": "пакет FTF",
   ...
   "steps": [
    "Скачайте APK из <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> и установите.",
   ...
   "build_text": "Нужны JDK 17, Android SDK 36 и NDK r28. Гостевые библиотеки собираются скриптами <code>native/*/build.sh</code>.",
   ...
   "credits_text": "AEmulator вырос из эмуляторов HTC Desire HD и HTC One M7 <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">первого автора</a> — без его движка проекта бы не было.",
   "support_title": "Поддержать проект",
   "support_text": "Если AEmulator вернул вам любимый телефон, можно поддержать разработку:",
   "links_title": "Ссылки",
   "l_site": "Сайт",
   "l_channel": "Telegram-канал",
   "l_author": "Автор",
   "l_orig": "Первый автор",
  ...
  "uk": {
   ...
   "c_skin": "Оболонка",
   "c_status": "Стан",
   "c_download": "Завантажити",
   "st_ok": "Працює",
   "st_partial": "Частково",
   "st_wip": "У роботі",
   "st_untested": "Не перевірено",
   "st_no": "Поки ні",
   "n_sound": "звук працює",
   "n_bt": "вікно помилки Bluetooth",
   "n_nosound": "поки без звуку",
   "n_wip": "доходить до майстра налаштування, доопрацьовується",
   "n_lollipop": "Android 5 — експериментально",
   "n_crash": "неофіційний порт падає",
   "n_arm64": "64-бітний Android 7 — потрібен майбутній рушій arm64",
   "dl_rootfs": "готовий архів для імпорту",
   "dl_factory": "factory-образ Google",
   "dl_odin": "пакет Odin",
   "dl_zip": "ZIP для рекавері",
   "dl_ftf": "пакет FTF",
   ...
   "steps": [
    "Завантажте APK з <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> і встановіть.",
   ...
   "build_text": "Потрібні JDK 17, Android SDK 36 і NDK r28. Гостьові бібліотеки збираються скриптами <code>native/*/build.sh</code>.",
   ...
   "credits_text": "AEmulator виріс з емуляторів HTC Desire HD та HTC One M7 <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">першого автора</a> — без його рушія проєкту б не було.",
  ...
  "de": {
   ...
   "st_wip": "In Arbeit",
   "st_untested": "Noch nicht getestet",
   "st_no": "Noch nicht",
   "n_sound": "Ton funktioniert",
   "n_bt": "Bluetooth-Fehlerdialog",
   "n_nosound": "noch kein Ton",
   "n_wip": "startet bis zur Einrichtung, wird stabilisiert",
   "n_lollipop": "Android 5 ist experimentell",
   "n_crash": "inoffizieller Port stürzt ab",
   "n_arm64": "64-Bit-Android 7 — braucht die geplante arm64-Engine",
   "dl_rootfs": "importfertiges Archiv",
   "dl_factory": "Google-Factory-Image",
   "dl_odin": "Odin-Paket",
   "dl_zip": "Recovery-ZIP",
   "dl_ftf": "FTF-Paket",
   ...
   "steps": [
    "APK unter <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> herunterladen und installieren.",
   ...
   "build_text": "Benötigt werden JDK 17, Android SDK 36 und NDK r28. Die Gast-Bibliotheken werden mit <code>native/*/build.sh</code> gebaut.",
   ...
   "credits_title": "Dank",
   "credits_text": "AEmulator ist aus den Emulatoren für HTC Desire HD und HTC One M7 <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">des Originalautors</a> hervorgegangen — ohne seine Engine gäbe es dieses Projekt nicht.",
  ...
  "fr": {
   ...
   "c_skin": "Surcouche",
   "c_status": "État",
   "c_download": "Téléchargement",
   "st_ok": "Fonctionne",
   "st_partial": "Partiel",
   "st_wip": "En cours",
   "st_untested": "Pas encore testé",
   "st_no": "Pas encore",
   "n_sound": "le son fonctionne",
   "n_bt": "boîte d’erreur Bluetooth",
   "n_nosound": "pas encore de son",
   "n_wip": "démarre jusqu’à l’assistant, en stabilisation",
   "n_lollipop": "Android 5 est expérimental",
   "n_crash": "le portage non officiel plante",
   "n_arm64": "Android 7 64 bits — nécessite le futur moteur arm64",
   "dl_rootfs": "archive prête à importer",
   "dl_factory": "image d’usine Google",
   "dl_odin": "paquet Odin",
   "dl_zip": "ZIP recovery",
   "dl_ftf": "paquet FTF",
   ...
   "steps": [
    "Téléchargez l’APK depuis <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> et installez-le.",
   ...
   "build_text": "Il faut JDK 17, Android SDK 36 et NDK r28. Les bibliothèques invitées se compilent avec <code>native/*/build.sh</code>.",
   ...
   "credits_text": "AEmulator est né des émulateurs HTC Desire HD et HTC One M7 de <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">l’auteur d’origine</a> — sans son moteur, ce projet n’existerait pas.",
  ...
  "es": {
   ...
   "st_partial": "Parcial",
   "st_wip": "En progreso",
   "st_untested": "Sin probar",
   "st_no": "Aún no",
   "n_sound": "el sonido funciona",
   "n_bt": "diálogo de error de Bluetooth",
   "n_nosound": "aún sin sonido",
   "n_wip": "arranca hasta el asistente, en estabilización",
   "n_lollipop": "Android 5 es experimental",
   "n_crash": "el port no oficial falla",
   "n_arm64": "Android 7 de 64 bits — requiere el futuro motor arm64",
   "dl_rootfs": "archivo listo para importar",
   "dl_factory": "imagen de fábrica de Google",
   "dl_odin": "paquete Odin",
   "dl_zip": "ZIP de recovery",
   "dl_ftf": "paquete FTF",
   ...
   "steps": [
    "Descarga el APK desde <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> e instálalo.",
   ...
   "build_text": "Necesitas JDK 17, Android SDK 36 y NDK r28. Las bibliotecas del invitado se compilan con <code>native/*/build.sh</code>.",
   ...
   "credits_text": "AEmulator nació de los emuladores de HTC Desire HD y HTC One M7 del <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">autor original</a>; sin su motor este proyecto no existiría.",
   "support_title": "Apoya el proyecto",
   "support_text": "Si AEmulator te devolvió un teléfono querido, puedes apoyar el desarrollo:",
   "links_title": "Enlaces",
   "l_site": "Sitio web",
   "l_channel": "Canal de Telegram",
   "l_author": "Autor",
  ...
  "pt-BR": {
   ...
   "st_partial": "Parcial",
   "st_wip": "Em andamento",
   "st_untested": "Não testado",
   "st_no": "Ainda não",
   "n_sound": "som funciona",
   "n_bt": "janela de erro do Bluetooth",
   "n_nosound": "ainda sem som",
   "n_wip": "inicia até a configuração, em estabilização",
   "n_lollipop": "Android 5 é experimental",
   "n_crash": "port não oficial trava",
   "n_arm64": "Android 7 64 bits — requer o futuro motor arm64",
   "dl_rootfs": "arquivo pronto para importar",
   "dl_factory": "imagem de fábrica do Google",
   "dl_odin": "pacote Odin",
   "dl_zip": "ZIP de recovery",
   "dl_ftf": "pacote FTF",
   ...
   "steps": [
    "Baixe o APK em <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> e instale.",
   ...
   "build_text": "É preciso JDK 17, Android SDK 36 e NDK r28. As bibliotecas do convidado são compiladas com <code>native/*/build.sh</code>.",
   ...
   "credits_title": "Créditos",
   "credits_text": "O AEmulator nasceu dos emuladores de HTC Desire HD e HTC One M7 do <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">autor original</a> — sem o motor dele este projeto não existiria.",
  ...
  "it": {
   ...
   "st_partial": "Parziale",
   "st_wip": "In corso",
   "st_untested": "Non testato",
   "st_no": "Non ancora",
   "n_sound": "audio funzionante",
   "n_bt": "finestra di errore Bluetooth",
   "n_nosound": "ancora senza audio",
   "n_wip": "si avvia fino alla configurazione, in stabilizzazione",
   "n_lollipop": "Android 5 è sperimentale",
   "n_crash": "il port non ufficiale va in crash",
   "n_arm64": "Android 7 a 64 bit — serve il futuro motore arm64",
   "dl_rootfs": "archivio pronto da importare",
   "dl_factory": "immagine di fabbrica Google",
   "dl_odin": "pacchetto Odin",
   "dl_zip": "ZIP per recovery",
   "dl_ftf": "pacchetto FTF",
   ...
   "steps": [
    "Scarica l’APK da <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> e installalo.",
   ...
   "build_text": "Servono JDK 17, Android SDK 36 e NDK r28. Le librerie ospiti si compilano con <code>native/*/build.sh</code>.",
   ...
   "credits_text": "AEmulator nasce dagli emulatori HTC Desire HD e HTC One M7 dell’<a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">autore originale</a>; senza il suo motore questo progetto non esisterebbe.",
   "support_title": "Sostieni il progetto",
   "support_text": "Se AEmulator ti ha ridato un telefono amato, puoi sostenere lo sviluppo:",
   "links_title": "Link",
   "l_site": "Sito web",
   "l_channel": "Canale Telegram",
   "l_author": "Autore",
  ...
  "pl": {
   ...
   "c_download": "Pobierz",
   "st_ok": "Działa",
   "st_partial": "Częściowo",
   "st_wip": "W toku",
   "st_untested": "Nietestowane",
   "st_no": "Jeszcze nie",
   "n_sound": "dźwięk działa",
   "n_bt": "okno błędu Bluetooth",
   "n_nosound": "na razie bez dźwięku",
   "n_wip": "dochodzi do kreatora, stabilizacja trwa",
   "n_lollipop": "Android 5 eksperymentalnie",
   "n_crash": "nieoficjalny port się wysypuje",
   "n_arm64": "64-bitowy Android 7 — wymaga planowanego silnika arm64",
   "dl_rootfs": "archiwum gotowe do importu",
   "dl_factory": "obraz fabryczny Google",
   "dl_odin": "pakiet Odin",
   "dl_zip": "ZIP do recovery",
   "dl_ftf": "pakiet FTF",
   ...
   "steps": [
    "Pobierz APK z <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> i zainstaluj.",
   ...
   "build_text": "Potrzebne są JDK 17, Android SDK 36 i NDK r28. Biblioteki gościa buduje się skryptami <code>native/*/build.sh</code>.",
   ...
   "credits_text": "AEmulator wyrósł z emulatorów HTC Desire HD i HTC One M7 <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">pierwotnego autora</a> — bez jego silnika tego projektu by nie było.",
   "support_title": "Wesprzyj projekt",
   "support_text": "Jeśli AEmulator przywrócił ci ulubiony telefon, możesz wesprzeć rozwój:",
   "links_title": "Linki",
   "l_site": "Strona",
   "l_channel": "Kanał Telegram",
   "l_author": "Autor",
  ...
  "tr": {
   ...
   "st_ok": "Çalışıyor",
   "st_partial": "Kısmen",
   "st_wip": "Üzerinde çalışılıyor",
   "st_untested": "Henüz denenmedi",
   "st_no": "Henüz değil",
   "n_sound": "ses çalışıyor",
   "n_bt": "Bluetooth hata penceresi",
   "n_nosound": "henüz ses yok",
   "n_wip": "kurulum sihirbazına kadar açılıyor, kararlı hâle getiriliyor",
   "n_lollipop": "Android 5 deneysel",
   "n_crash": "resmî olmayan port çöküyor",
   "n_arm64": "64 bit Android 7 — planlanan arm64 motoru gerekli",
   "dl_rootfs": "içe aktarmaya hazır arşiv",
   "dl_factory": "Google fabrika imajı",
   "dl_odin": "Odin paketi",
   "dl_zip": "recovery ZIP",
   "dl_ftf": "FTF paketi",
   ...
   "steps": [
    "APK’yı <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> sayfasından indirip kurun.",
   ...
   "build_text": "JDK 17, Android SDK 36 ve NDK r28 gerekir. Misafir kütüphaneleri <code>native/*/build.sh</code> betikleriyle derlenir.",
   ...
   "credits_text": "AEmulator, <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">ilk geliştiricinin</a> HTC Desire HD ve HTC One M7 emülatörlerinden doğdu — onun motoru olmadan bu proje olmazdı.",
  ...
  "ar": {
   ...
   "st_partial": "جزئيًا",
   "st_wip": "قيد العمل",
   "st_untested": "لم يُختبر",
   "st_no": "ليس بعد",
   "n_sound": "الصوت يعمل",
   "n_bt": "نافذة خطأ Bluetooth",
   "n_nosound": "بلا صوت حاليًا",
   "n_wip": "يصل إلى معالج الإعداد، قيد التحسين",
   "n_lollipop": "أندرويد 5 تجريبي",
   "n_crash": "المنفذ غير الرسمي ينهار",
   "n_arm64": "أندرويد 7 بمعمارية 64 بت — يحتاج محرك arm64 المخطط له",
   "dl_rootfs": "أرشيف جاهز للاستيراد",
   "dl_factory": "صورة مصنع Google",
   "dl_odin": "حزمة Odin",
   "dl_zip": "ZIP للريكفري",
   "dl_ftf": "حزمة FTF",
   ...
   "steps": [
    "نزّل ملف APK من <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> وثبّته.",
   ...
   "build_text": "تحتاج JDK 17 وAndroid SDK 36 وNDK r28. تُبنى مكتبات الضيف عبر <code>native/*/build.sh</code>.",
   "how_title": "كيف يعمل",
   ...
   "credits_text": "نشأ AEmulator من محاكيات HTC Desire HD وHTC One M7 التي صنعها <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">المطوّر الأصلي</a>، ولولا محركه ما وُجد هذا المشروع.",
   "support_title": "ادعم المشروع",
   "support_text": "إن أعاد إليك AEmulator هاتفًا أحببته، يمكنك دعم التطوير:",
   "links_title": "روابط",
   "l_site": "الموقع",
   "l_channel": "قناة تيليجرام",
   "l_author": "المطوّر",
  ...
  "fa": {
   ...
   "st_partial": "تا حدی",
   "st_wip": "در حال کار",
   "st_untested": "هنوز آزمایش نشده",
   "st_no": "هنوز نه",
   "n_sound": "صدا کار می‌کند",
   "n_bt": "پنجرهٔ خطای Bluetooth",
   "n_nosound": "فعلاً بدون صدا",
   "n_wip": "تا راه‌انداز بالا می‌آید، در حال پایدارسازی",
   "n_lollipop": "اندروید 5 آزمایشی است",
   "n_crash": "پورت غیررسمی کرش می‌کند",
   "n_arm64": "اندروید 7 ‏64 بیتی — به موتور arm64 آینده نیاز دارد",
   "dl_rootfs": "آرشیو آمادهٔ درون‌ریزی",
   "dl_factory": "ایمیج کارخانهٔ گوگل",
   "dl_odin": "بستهٔ Odin",
   "dl_zip": "ZIP ریکاوری",
   "dl_ftf": "بستهٔ FTF",
   ...
   "steps": [
    "فایل APK را از <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> دانلود و نصب کنید.",
   ...
   "build_text": "به JDK 17، Android SDK 36 و NDK r28 نیاز دارید. کتابخانه‌های مهمان با <code>native/*/build.sh</code> ساخته می‌شوند.",
   ...
   "credits_title": "سپاس",
   "credits_text": "AEmulator از شبیه‌سازهای HTC Desire HD و HTC One M7 ‏<a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">سازندهٔ نخست</a> رشد کرد — بدون موتور او این پروژه وجود نداشت.",
   "support_title": "حمایت از پروژه",
   "support_text": "اگر AEmulator گوشی محبوبتان را برگرداند، می‌توانید از توسعه حمایت کنید:",
   "links_title": "پیوندها",
   "l_site": "وب‌سایت",
   "l_channel": "کانال تلگرام",
   "l_author": "سازنده",
   "l_orig": "سازندهٔ نخست",
   "license_title": "مجوز",
  ...
  "hi": {
   ...
   "st_partial": "आंशिक",
   "st_wip": "काम जारी",
   "st_untested": "अभी परखा नहीं",
   "st_no": "अभी नहीं",
   "n_sound": "आवाज़ काम करती है",
   "n_bt": "Bluetooth त्रुटि संवाद",
   "n_nosound": "अभी आवाज़ नहीं",
   "n_wip": "सेटअप तक बूट होता है, स्थिर किया जा रहा है",
   "n_lollipop": "Android 5 प्रयोगात्मक",
   "n_crash": "अनौपचारिक पोर्ट क्रैश होता है",
   "n_arm64": "64-बिट Android 7 — नियोजित arm64 इंजन चाहिए",
   "dl_rootfs": "आयात के लिए तैयार आर्काइव",
   "dl_factory": "Google फ़ैक्टरी इमेज",
   "dl_odin": "Odin पैकेज",
   "dl_zip": "रिकवरी ZIP",
   "dl_ftf": "FTF पैकेज",
   ...
   "steps": [
    "<a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> से APK डाउनलोड करके इंस्टॉल करें।",
   ...
   "build_text": "JDK 17, Android SDK 36 और NDK r28 चाहिए। गेस्ट लाइब्रेरी <code>native/*/build.sh</code> से बनती हैं।",
   ...
   "credits_title": "आभार",
   "credits_text": "AEmulator <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">मूल लेखक</a> के HTC Desire HD और HTC One M7 एमुलेटर से विकसित हुआ — उनके इंजन के बिना यह प्रोजेक्ट नहीं होता।",
  ...
  "id": {
   ...
   "st_partial": "Sebagian",
   "st_wip": "Dikerjakan",
   "st_untested": "Belum diuji",
   "st_no": "Belum",
   "n_sound": "suara berfungsi",
   "n_bt": "dialog galat Bluetooth",
   "n_nosound": "belum ada suara",
   "n_wip": "boot sampai penyiapan, sedang distabilkan",
   "n_lollipop": "Android 5 eksperimental",
   "n_crash": "port tidak resmi crash",
   "n_arm64": "Android 7 64-bit — perlu mesin arm64 yang direncanakan",
   "dl_rootfs": "arsip siap impor",
   "dl_factory": "factory image Google",
   "dl_odin": "paket Odin",
   "dl_zip": "ZIP recovery",
   "dl_ftf": "paket FTF",
   ...
   "steps": [
    "Unduh APK dari <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> lalu pasang.",
   ...
   "build_text": "Butuh JDK 17, Android SDK 36, dan NDK r28. Pustaka tamu dibangun dengan <code>native/*/build.sh</code>.",
   ...
   "credits_text": "AEmulator tumbuh dari emulator HTC Desire HD dan HTC One M7 karya <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">pembuat asli</a> — tanpa mesinnya proyek ini tidak akan ada.",
  ...
  "vi": {
   ...
   "st_partial": "Một phần",
   "st_wip": "Đang làm",
   "st_untested": "Chưa thử",
   "st_no": "Chưa",
   "n_sound": "có âm thanh",
   "n_bt": "hộp thoại lỗi Bluetooth",
   "n_nosound": "chưa có âm thanh",
   "n_wip": "khởi động tới trình thiết lập, đang ổn định",
   "n_lollipop": "Android 5 là thử nghiệm",
   "n_crash": "bản port không chính thức bị lỗi",
   "n_arm64": "Android 7 64-bit — cần engine arm64 dự kiến",
   "dl_rootfs": "gói sẵn để nhập",
   "dl_factory": "factory image Google",
   "dl_odin": "gói Odin",
   "dl_zip": "ZIP recovery",
   "dl_ftf": "gói FTF",
   ...
   "steps": [
    "Tải APK từ <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> và cài đặt.",
   ...
   "build_text": "Cần JDK 17, Android SDK 36 và NDK r28. Thư viện khách được dựng bằng <code>native/*/build.sh</code>.",
   ...
   "credits_text": "AEmulator phát triển từ trình giả lập HTC Desire HD và HTC One M7 của <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">tác giả gốc</a> — không có engine của anh ấy thì không có dự án này.",
  ...
  "zh-CN": {
   ...
   "n_nosound": "暂无声音",
   "n_wip": "可进入开机向导，正在完善",
   "n_lollipop": "Android 5 为实验性",
   "n_crash": "非官方移植会崩溃",
   "n_arm64": "64 位 Android 7——需要规划中的 arm64 引擎",
   "dl_rootfs": "可直接导入的压缩包",
   "dl_factory": "Google 出厂镜像",
   "dl_odin": "Odin 包",
   "dl_zip": "卡刷 ZIP",
   "dl_ftf": "FTF 包",
   ...
   "start_title": "快速开始",
   "steps": [
    "从 <a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> 下载并安装 APK。",
    "把上表中的固件下载到手机。",
   ...
   "build_title": "从源码构建",
   "build_text": "需要 JDK 17、Android SDK 36 和 NDK r28。客户机库通过 <code>native/*/build.sh</code> 构建。",
   "how_title": "工作原理",
   ...
   "credits_title": "致谢",
   "credits_text": "AEmulator 源自<a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">原作者</a>的 HTC Desire HD 与 HTC One M7 模拟器——没有他的引擎就没有本项目。",
   "support_title": "支持项目",
   "support_text": "如果 AEmulator 让你心爱的手机重获新生，欢迎支持开发：",
   "links_title": "链接",
   "l_site": "网站",
   "l_channel": "Telegram 频道",
   "l_author": "作者",
   "l_orig": "原作者",
   "license_title": "许可证",
  ...
  "ja": {
   ...
   "st_no": "未対応",
   "n_sound": "音声あり",
   "n_bt": "Bluetooth エラー表示",
   "n_nosound": "音声はまだ",
   "n_wip": "初期設定まで起動、安定化中",
   "n_lollipop": "Android 5 は試験的",
   "n_crash": "非公式移植版はクラッシュ",
   "n_arm64": "64 ビット Android 7 — 予定中の arm64 エンジンが必要",
   "dl_rootfs": "そのまま取り込めるアーカイブ",
   "dl_factory": "Google ファクトリーイメージ",
   "dl_odin": "Odin パッケージ",
   "dl_zip": "リカバリー ZIP",
   "dl_ftf": "FTF パッケージ",
   ...
   "steps": [
    "<a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a> から APK をダウンロードしてインストール。",
   ...
   "build_text": "JDK 17、Android SDK 36、NDK r28 が必要です。ゲスト用ライブラリは <code>native/*/build.sh</code> でビルドします。",
   "how_title": "仕組み",
   ...
   "credits_title": "クレジット",
   "credits_text": "AEmulator は<a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">オリジナル作者</a>の HTC Desire HD・HTC One M7 エミュレーターから生まれました。そのエンジンなしにこのプロジェクトはありません。",
   "support_title": "プロジェクトを支援",
   "support_text": "AEmulator で思い出のスマホがよみがえったら、開発を支援できます：",
   "links_title": "リンク",
   "l_site": "ウェブサイト",
   "l_channel": "Telegram チャンネル",
   "l_author": "作者",
   "l_orig": "オリジナル作者",
   "license_title": "ライセンス",
  ...
  "ko": {
   ...
   "n_bt": "Bluetooth 오류 창",
   "n_nosound": "아직 소리 없음",
   "n_wip": "설정 마법사까지 부팅, 안정화 중",
   "n_lollipop": "Android 5는 실험적",
   "n_crash": "비공식 포팅은 충돌",
   "n_arm64": "64비트 Android 7 — 계획된 arm64 엔진 필요",
   "dl_rootfs": "바로 가져올 수 있는 아카이브",
   "dl_factory": "Google 팩토리 이미지",
   "dl_odin": "Odin 패키지",
   "dl_zip": "리커버리 ZIP",
   "dl_ftf": "FTF 패키지",
   ...
   "start_title": "빠른 시작",
   "steps": [
    "<a href=\"https://github.com/uxazu/aemulator/releases\" target=\"_blank\" rel=\"noopener\">Releases</a>에서 APK를 받아 설치합니다.",
   ...
   "build_title": "소스에서 빌드",
   "build_text": "JDK 17, Android SDK 36, NDK r28이 필요합니다. 게스트 라이브러리는 <code>native/*/build.sh</code>로 빌드합니다.",
   "how_title": "작동 방식",
   ...
   "credits_title": "감사의 말",
   "credits_text": "AEmulator는 <a href=\"https://t.me/istratii_tech\" target=\"_blank\" rel=\"noopener\">원작자</a>의 HTC Desire HD·HTC One M7 에뮬레이터에서 시작되었습니다. 그의 엔진이 없었다면 이 프로젝트도 없었습니다.",
